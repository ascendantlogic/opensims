...
//_global.INSTANCE = _root.instance;
...
_global.SOCKET = _root.attachMovie("Socket", "Socket", 1);
...
_global.SOCKET.socketControl.setSize(40,35);
_global.SOCKET.socketControl.useHandCursor = true;
_global.SOCKET.socketControl._x = 50;
_global.SOCKET.socketControl._y = 5;
...
_global.XML_SOCKET.subscribe({stream:"viz", delay:500, refresh:5000, activity:30000, threat:"perimeter", network_id:0, throttle:50});

// Load in live.swf
//_global.MCLoader.loadClip("live_widget.swf", _root.UI_CONTENT);
